...
export const todoSlice = createSlice({
    ...
    reducers: {
        addTodo: {
            ...
            markComplete(state: { allTodos: { id: any; completed: any }[] }, action: { payload: any }) {
                const todoId = action.payload
                state.allTodos = state.allTodos.map(function (todo: { id: any; completed: any} ): { id: any; completed: any}  {
                        if (todo.id === todoId)
