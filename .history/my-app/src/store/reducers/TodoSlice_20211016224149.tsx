...
export const todoSlice = createSlice({
    ...
    reducers: {
        addTodo: {
            ...
            markComplete({ state, action }: { state: { allTodos: { id: any; completed: boolean} []} ; action: { payload: any| void}  }): void {
                const todoId = action.payload
                state.allTodos = state.allTodos.map((todo: { id: any; completed: boolean }) => {
